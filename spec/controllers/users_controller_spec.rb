...
describe UsersController do
  ...
  describe "PUT 'update'" do 
    ...
    describe "success" do 
      ...
      before(:each) do
        @attr = { :name => "New Name", :email => "user@example.org", :password => "snoops1", :password_confirmation => "snoops1" }
      end
  ...
  describe "not being able to sign up if you're already signed in" do
